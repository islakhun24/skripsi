...
import Navbar from "@material-ui/utils/";
...
const EventSessionTopbar = () => {
  ...
  const isOwner = useMemo(
    () => user && user.id === eventSessionDetails.owner,
    [eventSessionDetails.owner, user]
  );
        ...
        <Toolbar style={{ position: "relative" }}>
          ...
          <div className={classes.avatarContainer}>
            ...
            >
              ...
              {isOwner && <Divider />}
              {isOwner && (
                <MenuItem onClick={handleEditEventClick}>Edit Kelas</MenuItem>
              )}
              {/* {isOwner && (
              ...
              <MenuItem onClick={handleLogoutClick}>Keluar</MenuItem>
            </Menu>
          </div>
        </Toolbar>
      </AppBar>
