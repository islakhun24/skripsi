...
export default function EventPage(props) {
  ...
  const hasTicketsEnabled = React.useMemo(
    () => ticketsProperties !== null,
    [ticketsProperties]
  );
    ...
    <Card className={classes.root}>
      ...
      {!isPreview && user && user.uid === owner && (
        <Button
          ...
          style={{ backgroundColor: "rgba(92, 145, 219)", color: "#fff" }}
        >
          Ubah Event
        </Button>
      )}
        ...
        <>
          ...
          {(!bannerUrl || bannerUrl.trim() === "") && (
            <CardMedia
              component="img"
              alt={title}
              image="https://coolbackgrounds.io/images/backgrounds/blue/blue-background-088FDC-8ecd0503.jpg"
              title={title}
            />
          )}
        </>
          ...
          <div className={classes.ctaContainer}>
              ...
              <div>
                ...
                {hasRsvpEnabled && isRegistered && (
                  ...
                  >
                    ...
                    <Typography>Kamu telah terdaftari di kelas ini</Typography>
                  </div>
                )}
                <MUIAddToCalendar
                  event={calendarEvent}
            ...
            {isOver && (
              ...
              >
                ...
                <Alert severity="info">Kelas ini telah berakhir</Alert>
              </div>
            )}
          </div>
        )}
